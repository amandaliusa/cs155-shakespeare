...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}58}]:} \PY{c+c1}{\PYZsh{} load the network weights from best checkpoint}
         \PY{c+c1}{\PYZsh{}filename = \PYZdq{}weights\PYZhy{}improvement\PYZhy{}20\PYZhy{}1.7396.hdf5\PYZdq{}}
         \PY{n}{filename} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{weights\PYZhy{}improvement\PYZhy{}61\PYZhy{}1.1807.hdf5}\PY{l+s+s2}{\PYZdq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}59}]:} \PY{c+c1}{\PYZsh{} set seed for emissions}
